      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-body-md text-muted-foreground">
            Lending app for Friends and Family.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-surface px-3 text-label-md text-muted-foreground">
              or
            </span>
          </div>
        </div>
        ...
        <p className="text-center text-body-md text-muted-foreground">
          ...
          <Link href="/signup" className="text-on-surface font-medium hover:underline">
            Sign up for free
          </Link>
        </p>
